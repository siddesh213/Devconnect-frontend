...
const Connections = () => {
  ...
  const fetchConnections = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`${API_BASE_URL}/connection/accepted`, {
            ...
            >
              ...
              <div className="mt-6 flex justify-center gap-4">
                <button 
                  ...
                  className="btn btn-sm bg-emerald-600 hover:bg-emerald-700 border-none text-white shadow-md hover:shadow-lg transition-all"
                >
                  💬 Message
                </button>
                <button 
